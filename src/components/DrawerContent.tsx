...
const NAV_ITEMS = [
  ...
  { label: 'Long Storage', icon: 'archive-outline' as const, tab: 'LongStorage' },
  { label: 'Issuing', icon: 'cart-outline' as const, tab: 'Issuing' },
  { label: 'Dispatch', icon: 'send-outline' as const, tab: 'Dispatch' },
  { label: 'Chat', icon: 'chatbubbles-outline' as const, tab: 'Chat' },
